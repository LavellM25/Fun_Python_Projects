...
def processing(num_randoms):
    ...
    :param num_randoms: The number of random numbers to generate given user input.
    ...
    random_list.sort()  # Sort the list in ascending order from least to greatest in random list
