...
def processing(command, readings):
    ...
    if command == 'view':
        ...
        display_menu()  # Redisplay the menu for assistance
...
def display_menu():
    ...
    outputs("help  - Redisplay menu for assistance")
...
def add(readings):
    ...
    # Validate if the author input is not empty
    if not author.strip():
        outputs("Author name cannot be empty.\n")
        return  # Return to the main loop without adding the entry
    ...
    if author in readings:
        ...
        # Validate if the title input is not empty
        if not title.strip():
            outputs("Title cannot be empty.\n")
            return  # Return to the main loop without adding the entry
...
def edit(readings):
    ...
    if not author.strip():
        outputs("Author name cannot be empty.\n")
        return  # Return to the main loop without making changes
